...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description:
        "Personal full-stack project demonstrating comprehensive web development skills with modern technologies and best practices.",
      image: "/api/placeholder/600/400",
      technologies: [
        "React",
        "Bootstrap",
    ...
    },
    {
      ...
      title: "Spotify Clone",
      description:
        "Spotify Clone is a React application that replicates Spotify's core music streaming functionality with a modern UI. It features music playback controls, album browsing, and responsive design using React and Tailwind CSS.",
      image: "/api/placeholder/600/400",
      technologies: [
        "React",
        "TailwindCSS",
    ...
    },
    {
      ...
      description:
        "React application with AI/ML integration for real-time sentiment detection and analysis of text data with interactive visualizations.",
      image: "/api/placeholder/600/400",
      technologies: [
        "HTML5",
        "CSS3",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 fade-in-up">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              A showcase of my recent work in full-stack development, featuring
